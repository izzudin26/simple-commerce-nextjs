...
const SellerNavbar = () => {
  ...
  return (
    <>
      <div className="w-full flex-row space-x-5 p-5 items-center flex justify-between shadow">
      ...
      <div className={`${toggleNavbar ? ' w-64  p-5 ' : 'w-0 p-0'} overflow-hidden flex flex-col transform transition-width duration-500 fixed right-0 top-0 h-screen bg-blue-600 space-y-5 z-30 rounded-l-sm items-start`}>
